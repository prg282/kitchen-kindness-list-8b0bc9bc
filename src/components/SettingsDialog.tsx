...
import { Settings, Globe, Crown, Lock } from 'lucide-react';
...
export function SettingsDialog() {
  const { language, setLanguage, t, isPremium } = useLanguage();
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-6 py-4">
          ...
          <div>
            ...
            {!isPremium && (
              <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-4">
